...
<section class="vh-100 bg-image"
  ...
  <div class="mask d-flex align-items-center h-100 gradient-custom-3" class="p-3 mb-2 bg-warning text-dark">
            ...
            <div class="card-body p-5">
              ...
              <form action="saveReg" method="post">
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit"
                    class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" value="save">Register</button>
                </div>

                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="showLoginPage"
